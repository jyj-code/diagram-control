    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                foreach (DiagramItem item in diagramControl2.Items)
                {
                    SetNodeColor(item);
                }


                //diagramControl2.NodeCreating += (sender, args) =>
                //{
                //    int level = args.NodeData.Level; // 假设可以从 NodeData 中获取层级信息
                //    args.Node.BackColor = levelToColorMap[level]; // 或者 GetColorByLevel(level);
                //};
            }
        }
